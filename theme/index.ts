...
import { colorTokens, lightColors } from "./tokens.theme";

type ColorName = keyof typeof colorTokens.light;
...
const allThemes = addChildren(baseThemes, (name, theme) => {
  ...
  const baseActiveTheme = applyMask(colorThemes.primary, masks.weaker, {
    ...maskOptions,
    strength: 4,
  });
